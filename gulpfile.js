...
gulp.task("injectLayoutStyles", function () {
  var verticalLightStream = gulp
    ...
    .pipe(
      inject(
        gulp.src(["./assets/css/vertical-layout-light/style.css"], {
          read: false,
        }),
        { relative: true }
      )
...
gulp.task("copyMapFiles", function () {
  ...
  var map3 = gulp
    .src(
      "../node_modules/jquery-contextmenu/dist/jquery.contextMenu.min.css.map"
    )
    .pipe(gulp.dest("./assets/vendors/jquery-contextmenu"));
  var map4 = gulp
    .src(
      "../node_modules/jquery-contextmenu/dist/jquery.contextMenu.min.js.map"
    )
    .pipe(gulp.dest("./assets/vendors/jquery-contextmenu"));
  var map5 = gulp
    .src(
  ...
  var map6 = gulp
    .src(
      "../node_modules/jquery-asColorPicker/dist/css/asColorPicker.min.css.map"
    )
    .pipe(gulp.dest("./assets/vendors/jquery-asColorPicker/css"));
  var map7 = gulp
